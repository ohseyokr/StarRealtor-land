...
-- ('lnd-101', 'u-staff-1', '강원도 평창군 대관령면 수하리 청정 임야 매물', '강원특별자치도 평창군 대관령면 수하리 산 45-2', '임', 3305, 350000000, '보전관리지역', '2차선 포장도로 접함', 'https://www.youtube.com/embed/5dkJswCyOtg', '/sample-luris.pdf', '/sample-ledger.pdf', '/sample-cadastral.pdf', 'ACTIVE'),
-- ('lnd-102', 'u-staff-1', '충남 당진시 신평면 금천리 도로 접한 넓은 밭(전)', '충청남도 당진시 신평면 금천리 123-5', '전', 1652, 180000000, '계획관리지역', '4m 마을 농로 구거 접함', 'https://www.youtube.com/embed/5dkJswCyOtg', '/sample-luris.pdf', '/sample-ledger.pdf', '/sample-cadastral.pdf', 'ACTIVE'),
-- ('lnd-103', 'u-staff-1', '경기 용인시 처인구 양지면 대지 (즉시 건축 가능)', '경기도 용인시 처인구 양지면 양지리 78-1', '대', 660, 820000000, '제1종일반주거지역', '6m 지적도상 도로 완비', 'https://www.youtube.com/embed/5dkJswCyOtg', '/sample-luris.pdf', '/sample-ledger.pdf', '/sample-cadastral.pdf', 'ACTIVE'),
-- ('lnd-104', 'u-staff-1', '(임야) 경기도 포천시 창수면 가양리 369-6', '경기도 포천시 창수면 가양리 369-6', '임', 4958, 290000000, '계획관리지역', '4m 포장도로 접함', 'https://www.youtube.com/embed/5dkJswCyOtg', '/sample-luris.pdf', '/sample-ledger.pdf', '/sample-cadastral.pdf', 'ACTIVE'),
-- ('lnd-105', 'u-staff-1', '(대지) 경기도 양주시 고암동 603-7', '경기도 양주시 고암동 603-7', '대', 495, 650000000, '제1종일반주거지역', '6m 진입도로 완비', 'https://www.youtube.com/embed/5dkJswCyOtg', '/sample-luris.pdf', '/sample-ledger.pdf', '/sample-cadastral.pdf', 'ACTIVE'),
-- ('lnd-106', 'u-staff-1', '(공장용지) 경기도 포천시 내촌면 마명리 337', '경기도 포천시 내촌면 마명리 337', '장', 2314, 1250000000, '계획관리지역', '8m 대로변 접함', 'https://www.youtube.com/embed/5dkJswCyOtg', '/sample-luris.pdf', '/sample-ledger.pdf', '/sample-cadastral.pdf', 'ACTIVE')
