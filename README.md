...
| `DATABASE_URL` | `postgres://user:pass@ep-xxxx.render.com/land_db_00ml` | Render PostgreSQL 연결 URI |
...
* 배포가 완료되면 제공된 `https://starrealtor-land.onrender.com` 주소로 접속하여 360° VR 가상투어, Canvas 보안 PDF 뷰어, Google Meet 화상미팅 매칭 및 법적 공시 헤더/푸터 바인딩 동작을 확인합니다!
